...
the urlpatterns will include the URLs generated by the router for the ElevatorSystemViewSet and ElevatorViewSet. The router automatically handles URL patterns for various actions defined in the viewsets. The api endpoints are 
http://yourdomain.com/api/elevator_system/<action_method_name>/?params
and  http://yourdomain.com/api/elevator/<action_method_name>/?params

Example - http://127.0.0.1:8000/api/elevator_system/assign_elevator/?floor=3
...
-   initialize\_elevators: Initializes a specified number of elevators
    ...
    system. params: nums_elevator(optional)

-   get\_elevator\_system: Retrieves the elevator system details,
    assuming there is only one elevator system. params: none
...
-   assign\_elevator: Assigns an available elevator to a user request
    ...
    the request details and returns the serialized assigned elevator. params: floor
...
-   get\_elevator\_requests: Retrieves all elevator requests or requests
    ...
    data. params: id (elevator id (optional))

**<u>ElevatorViewSet:</u>**

-   get\_elevator\_details: Retrieves details of a specific elevator
    based on the provided elevator ID and returns the serialized data. params: id
...
-   change\_elevator\_status: Changes the status of a specific elevator
    ...
    the serialized data for the updated elevator. params: id, status
